...
const matchedTodoItem = todoList.value.find((item) => {
  // return item.id === parseInt(currentRoute.params.id); // Local data의 id는 number
  return item.id === currentRoute.params.id; // db.json의 id는 문자열
});
// console.log(matchedTodoItem);
